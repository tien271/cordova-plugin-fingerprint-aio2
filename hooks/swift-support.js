...
var fs = require('fs'),
	...
	DISABLE_FINGERPRINT_AIO_HOOK = process.env.DISABLE_FINGERPRINT_AIO_HOOK ? true : false,
	...
	IOSRTC_BRIDGING_HEADER = 'cordova-plugin-fingerprint-aio-Bridging-Header.h',
	BRIDGING_HEADER_END = '/Plugins/cordova-plugin-fingerprint-aio/' + IOSRTC_BRIDGING_HEADER,
...
function debug(msg) {
	console.log('[cordova-plugin-fingerprint-aio] [INFO] ' + msg);
}

function debugError(msg) {
	console.error('[cordova-plugin-fingerprint-aio] [ERROR] ' + msg);
	process.exit(1);
}
...
module.exports = function (context) {
	...
	*/
	...
	if (DISABLE_FINGERPRINT_AIO_HOOK) {
		debug('cordova-plugin-fingerprint-aio hook is disabled');
		return;
	}
	...
	debug('cordova-plugin-fingerprint-aio hook is checking issues in the generated project files:');
	debug(
